...
- 黄色曲线（有反思 + 外部反馈）：
  ...
  - 外部反馈为系统注入了“新信息”，使其不再局限于模型自身的知识库和推理能力。
   ...
   ![alt text](/content-assets/agentic-ai/agentic-ai-使用外部反馈-using-external-feedback/e5d02acdb0.png)

## 二、外部反馈的案例

  ![alt text](/content-assets/agentic-ai/agentic-ai-使用外部反馈-using-external-feedback/60ab482bf4.png)
...
- 反思流程：
  ...
  ![alt text](/content-assets/agentic-ai/agentic-ai-使用外部反馈-using-external-feedback/22b391a25e.png)
